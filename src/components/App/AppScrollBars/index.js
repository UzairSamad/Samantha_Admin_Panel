...
import WithRouterAndRef from '../Core/WithRouterAndRef';
...
const AppScrollBars = React.forwardRef((props, ref) => {
    ref = ref || createRef();
...
function mapStateToProps({ AppReducers }) {
    return {
        customScrollbars: AppReducers.settings.current.customScrollbars
    };
}

AppScrollBars.propTypes = {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(WithRouterAndRef(AppScrollBars));