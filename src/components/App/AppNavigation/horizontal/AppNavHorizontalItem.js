...
function AppNavHorizontalItem(props) {
	...
	return (
		...
		>
			...
			{item.badge && <AppNavBadge className="ltr:ml-8 rtl:mr-8" badge={item.badge} />}
		</ListItem>
	);
}

AppNavHorizontalItem.propTypes = {
...
AppNavHorizontalItem.defaultProps = {};

const NavHorizontalItem = withRouter(React.memo(AppNavHorizontalItem));
