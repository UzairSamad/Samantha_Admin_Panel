...
function AppNavHorizontalGroup(props) {
...
AppNavHorizontalGroup.propTypes = {
...
AppNavHorizontalGroup.defaultProps = {};

const NavHorizontalGroup = withRouter(React.memo(AppNavHorizontalGroup));
