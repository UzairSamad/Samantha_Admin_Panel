...
function AppNavHorizontalCollapse(props) {
					...
					{({ ref }) => (
						<div ref={ref}>
							...
							>
								...
								{item.badge && <AppNavBadge className="mx-4" badge={item.badge} />}
...
AppNavHorizontalCollapse.propTypes = {
...
AppNavHorizontalCollapse.defaultProps = {};

const NavHorizontalCollapse = withRouter(React.memo(AppNavHorizontalCollapse));
