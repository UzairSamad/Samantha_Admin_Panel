...
function AppNavVerticalCollapse(props) {
...
AppNavVerticalCollapse.propTypes = {
...
AppNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = withRouter(React.memo(AppNavVerticalCollapse
));
