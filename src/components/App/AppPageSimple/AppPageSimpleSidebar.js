...
import AppPageSimpleSidebarContent from './AppPageSimpleSidebarContent';

function AppPageSimpleSidebar(props, ref) {
	...
	return (
		<>
			<Hidden lgUp={props.variant === 'permanent'}>
				...
				>
					<AppPageSimpleSidebarContent {...props} />
				</Drawer>
			</Hidden>
...
export default React.forwardRef(AppPageSimpleSidebar);
