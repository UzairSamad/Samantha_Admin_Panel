...
import AppPageSimpleHeader from './AppPageSimpleHeader';
import AppPageSimpleSidebar from './AppPageSimpleSidebar';
...
const AppPageSimple = React.forwardRef((props, ref) => {
	// console.info("render::AppPageSimple");
	...
	return (
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			...
			<div className="flex flex-auto flex-col container z-10 h-full">
				{props.header && props.sidebarInner && <AppPageSimpleHeader header={props.header} classes={classes} />}

				<div className={classes.wrapper}>
					{(props.leftSidebarHeader || props.leftSidebarContent) && (
						<AppPageSimpleSidebar
							position="left"
					...
					>
						{props.header && !props.sidebarInner && (
							<AppPageSimpleHeader header={props.header} classes={classes} />
						)}
...
AppPageSimple.defaultProps = {};

export default React.memo(AppPageSimple);
