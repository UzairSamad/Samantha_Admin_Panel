...
import AppPageCardedHeader from './AppPageCardedHeader';
import AppPageCardedSidebar from './AppPageCardedSidebar';
...
const AppPageCarded = React.forwardRef((props, ref) => {
	...
	return (
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			...
			<div className="flex container w-full">
				...
				>
					<AppPageCardedHeader header={props.header} classes={classes} />
...
AppPageCarded.defaultProps = {};

export default React.memo(AppPageCarded);
