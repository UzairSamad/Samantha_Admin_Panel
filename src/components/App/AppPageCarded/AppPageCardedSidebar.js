...
import AppPageCardedSidebarContent from './AppPageCardedSidebarContent';

function AppPageCardedSidebar(props, ref) {
	...
	return (
		<>
			<Hidden lgUp={props.variant === 'permanent'}>
				...
				>
					<AppPageCardedSidebarContent {...props} />
				</Drawer>
			</Hidden>
...
export default React.forwardRef(AppPageCardedSidebar);
